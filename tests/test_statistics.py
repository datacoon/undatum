...
from undatum.cmds.statistics import StatProcessor, get_iterable_options, _detect_engine
...
class TestDetectEngine:
    ...
    @patch('undatum.cmds.statistics.detect_file_type')
...
class TestStatProcessor:
    ...
    @patch('undatum.cmds.statistics.open_iterable_with_s3')
    @patch('undatum.cmds.statistics.open_iterable')
    def test_stats_iterable_engine(self, mock_open_iterable, mock_open_s3, mock_detect):
    ...
    @patch('undatum.cmds.statistics.duckdb')
    ...
    def test_stats_duckdb_error_fallback(self, mock_duckdb, mock_detect):
        ...
        try:
            ...
            with patch('undatum.cmds.statistics.open_iterable') as mock_open:
                mock_iterable = MagicMock()
