...
class TestDatabaseQueryExecutor:
    ...
    def test_query_jsonl_output(self, mock_parse_uri, mock_get_conn):
        ...
        try:
            executor.query("SELECT * FROM users", "sqlite://:memory:", output=output_path, output_format='jsonl')
    ...
    def test_query_csv_output(self, mock_parse_uri, mock_get_conn):
        ...
        try:
            executor.query("SELECT * FROM users", "sqlite://:memory:", output=output_path, output_format='csv')
    ...
    def test_query_parquet_output(self, mock_import, mock_parse_uri, mock_get_conn):
        ...
        try:
            executor.query("SELECT * FROM users", "sqlite://:memory:", output=output_path, output_format='parquet')
            
            # Verify DataFrame was created and to_parquet was called
    ...
    def test_query_stdout_output(self, mock_parse_uri, mock_get_conn):
        ...
        with patch('sys.stdout') as mock_stdout:
            executor.query("SELECT * FROM users", "sqlite://:memory:", output=None, output_format='jsonl')
    ...
    def test_query_postgresql_named_cursor(self, mock_import, mock_parse_uri, mock_get_conn):
        ...
        try:
            executor.query("SELECT * FROM users", "postgresql://localhost/db", output=output_path, output_format='jsonl')
    ...
    def test_query_parquet_no_pandas(self, mock_import, mock_parse_uri, mock_get_conn):
        ...
        with pytest.raises(ImportError):
            executor.query("SELECT * FROM users", "sqlite://:memory:", output='test.parquet', output_format='parquet')
