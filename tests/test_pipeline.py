...
from undatum.common.pipeline_parser import PipelineSpec, PipelineParseError
...
class TestPipelineRunner:
    ...
    def test_run_dry_run(self):
        ...
        steps = [
            {'name': 'step1', 'command': 'convert', 'args': {'input': 'test.csv'}}
        ]
    ...
    def test_run_with_variables(self, mock_logger):
        ...
        steps = [
            {'name': 'step1', 'command': 'convert', 'args': {'input': '${INPUT_FILE}'}}
        ]
