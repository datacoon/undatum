...
class TestOpenIterableWithS3:
    ...
    def test_open_local_file(self, mock_open_iterable, mock_is_s3_uri):
        ...
        mock_open_iterable.assert_called_once_with('/local/path/file.jsonl', mode='r', iterableargs={})
    ...
    @patch('os.remove')
    def test_open_s3_file_read(self, mock_remove, mock_exists, mock_close, mock_mkstemp,
                                 mock_open_iterable, mock_get_client, mock_parse_uri, mock_is_s3_uri):
        ...
        mock_client.download_file.assert_called_once_with('my-bucket', 'path/to/file.jsonl', mock_temp_file)
    ...
    @patch('os.path.exists')
    @patch('os.remove')
    def test_open_s3_file_with_region(self, mock_remove, mock_exists, mock_close, mock_mkstemp,
                                       mock_open_iterable, mock_get_client, mock_parse_uri, mock_is_s3_uri):
        ...
        with open_iterable_with_s3('s3://my-bucket/file.jsonl', mode='r', region='us-east-1') as result:
            assert result == mock_iterable
    ...
    @patch('os.path.exists')
    @patch('os.remove')
    def test_open_s3_file_with_profile(self, mock_remove, mock_exists, mock_close, mock_mkstemp,
                                        mock_open_iterable, mock_get_client, mock_parse_uri, mock_is_s3_uri):
        ...
        with open_iterable_with_s3('s3://my-bucket/file.jsonl', mode='r', profile='myprofile') as result:
            assert result == mock_iterable
    ...
    @patch('os.path.exists')
    @patch('os.remove')
    def test_open_s3_file_cleanup_on_error(self, mock_remove, mock_exists, mock_close, mock_mkstemp,
                                           mock_open_iterable, mock_get_client, mock_parse_uri, mock_is_s3_uri):
    ...
    @patch('os.path.exists')
    @patch('os.remove')
    def test_open_s3_file_no_extension(self, mock_remove, mock_exists, mock_close, mock_mkstemp,
                                        mock_open_iterable, mock_get_client, mock_parse_uri, mock_is_s3_uri):
    ...
    @patch('os.path.exists')
    @patch('os.remove')
    def test_open_s3_file_remove_error(self, mock_remove, mock_exists, mock_close, mock_mkstemp,
                                        mock_open_iterable, mock_get_client, mock_parse_uri, mock_is_s3_uri):
    ...
    def test_open_local_file_with_iterableargs(self, mock_open_iterable, mock_is_s3_uri):
        ...
        with open_iterable_with_s3('/local/path/file.csv', mode='r', iterableargs=iterableargs) as result:
            assert result == mock_iterable

        mock_open_iterable.assert_called_once_with('/local/path/file.csv', mode='r', iterableargs=iterableargs)
