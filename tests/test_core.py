...
class TestEnableVerbose:
    ...
    @patch('undatum.core.logging.basicConfig')
...
class TestCoreCommands:
    ...
    def test_convert_command(self, mock_converter_class):
        ...
        with patch('undatum.core.Converter') as mock_conv:
    ...
    def test_validate_command(self, mock_validator_class):
        ...
        with patch('undatum.core.Validator') as mock_val:
    ...
    @patch('undatum.core.PipelineRunner')
    @patch('undatum.core.parse_pipeline')
    ...
    @patch('undatum.core.parse_pipeline')
    @patch('undatum.core.validate_pipeline')
