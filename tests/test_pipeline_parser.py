...
class TestPipelineSpec:
        ...
        steps = [
            {
                "name": "step1",
                "command": "convert",
                "args": {"input": "${INPUT}", "options": {"format": "${FORMAT}"}},
            }
        ]
    ...
    def test_resolve_variables_list(self):
        ...
        steps = [
            {"name": "step1", "command": "convert", "args": {"fields": ["${FIELD1}", "${FIELD2}"]}}
        ]
...
class TestParsePipeline:
    ...
    def test_parse_pipeline_yaml(self):
        ...
        pipeline_data = {
            "steps": [{"name": "step1", "command": "convert", "args": {}}],
            "variables": {},
        }
    ...
    def test_parse_pipeline_missing_command(self):
        ...
        pipeline_data = {"steps": [{"name": "step1", "args": {}}], "variables": {}}
    ...
    def test_parse_pipeline_missing_name(self):
        ...
        pipeline_data = {"steps": [{"command": "convert", "args": {}}], "variables": {}}
...
class TestValidatePipeline:
    ...
    def test_validate_pipeline_invalid_args(self):
        ...
        steps = [{"name": "step1", "command": "convert", "args": "invalid"}]
        spec = PipelineSpec(steps)
        errors = validate_pipeline(spec)
        assert len(errors) > 0
