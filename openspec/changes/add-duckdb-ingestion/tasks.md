...
- [ ] 2.2.1 Test with DuckDB file database
- [ ] 2.2.2 Test with DuckDB in-memory database
- [ ] 2.2.3 Test COPY FROM with various data types
- [ ] 2.2.4 Test Appender API with streaming data
- [ ] 2.2.5 Test Parquet intermediate format
- [ ] 2.2.6 Test schema auto-creation
- [ ] 2.2.7 Test with large files (100K+ rows)
- [ ] 2.2.8 Test connection string parsing

### 2.3 Performance Tests
- [ ] 2.3.1 Benchmark COPY FROM vs Appender API performance
- [ ] 2.3.2 Test throughput with different batch sizes
- [ ] 2.3.3 Test Parquet intermediate format performance
