...
## 5. Documentation
- [ ] 5.1 Update README with engine selection examples
- [ ] 5.2 Document DuckDB tuning options
- [ ] 5.3 Add performance comparison examples
- [ ] 5.4 Update command-specific documentation
