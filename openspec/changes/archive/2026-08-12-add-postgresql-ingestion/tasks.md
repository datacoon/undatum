...
- [ ] 2.2.1 Test with real PostgreSQL instance (Docker container) - Deferred
- [x] 2.2.2 Test COPY FROM with various data types
- [x] 2.2.3 Test upsert with conflict resolution
- [x] 2.2.4 Test schema auto-creation with different schemas
- [ ] 2.2.5 Test with large files (100K+ rows) - Deferred
- [x] 2.2.6 Test connection string parsing
- [ ] 2.2.7 Test different PostgreSQL versions (12, 13, 14, 15, 16) - Deferred

### 2.3 Performance Tests
- [ ] 2.3.1 Benchmark COPY FROM vs INSERT performance - Deferred
- [ ] 2.3.2 Test throughput with different batch sizes - Deferred
- [ ] 2.3.3 Test connection pooling impact on performance - Deferred
- [ ] 2.3.4 Compare with MongoDB ingestion performance - Deferred
