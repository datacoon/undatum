...
- [ ] 2.2.1 Test with real MySQL instance (Docker container) - Deferred
- [x] 2.2.2 Test with SQLite file database
- [x] 2.2.3 Test with SQLite in-memory database
- [ ] 2.2.4 Test LOAD DATA INFILE with various data types - Deferred (requires MySQL)
- [x] 2.2.5 Test upsert operations for both databases
- [x] 2.2.6 Test schema auto-creation
- [ ] 2.2.7 Test with large files (100K+ rows) - Deferred (benchmark scale)
- [x] 2.2.8 Test connection string parsing
- [ ] 2.2.9 Test different MySQL versions (5.7, 8.0+) - Deferred
- [ ] 2.2.10 Test different SQLite versions (3.24+, 3.40+) - Deferred

### 2.3 Performance Tests
- [ ] 2.3.1 Benchmark MySQL LOAD DATA vs INSERT performance - Deferred
- [ ] 2.3.2 Benchmark SQLite with and without PRAGMA optimizations - Deferred
- [ ] 2.3.3 Test throughput with different batch sizes - Deferred
...
- [x] 4.1.1 Handle connection errors gracefully
- [ ] 4.1.2 Handle LOAD DATA INFILE permission errors - Deferred (requires MySQL)
- [x] 4.1.3 Handle schema mismatch errors
- [x] 4.1.4 Handle constraint violation errors
- [x] 4.1.5 Provide actionable error messages

### 4.2 SQLite-Specific Errors
- [x] 4.2.1 Handle file permission errors
- [x] 4.2.2 Handle schema mismatch errors
- [x] 4.2.3 Handle constraint violation errors
- [x] 4.2.4 Handle database locked errors (single writer limitation)
- [x] 4.2.5 Provide actionable error messages

### 4.3 Error Recovery
- [x] 4.3.1 Implement retry logic for transient errors
- [x] 4.3.2 Handle partial batch failures
- [x] 4.3.3 Log errors with context
