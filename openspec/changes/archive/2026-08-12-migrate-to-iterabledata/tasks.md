...
- [x] 3.3 Integrate DuckDB engine option for performance-critical operations (where applicable)
...
- [x] 4.4 Remove or archive local `IterableData` and `DataWriter` classes after migration complete (deferred - keep for backward compatibility during deprecation period)
