...
- [x] 4.2 Add filtering and aggregation
  - Filter data before plotting (`--filter`)
  - Aggregate data for bar charts (`count`/`sum`/`mean`, `--value-field`, `--top-n`)
- [ ] 4.3 Add optional interactive backends
  - Plotly integration (optional) — deferred (Phase 3)
  - Bokeh integration (optional) — deferred (Phase 3)
  - HTML output for interactive plots — deferred (Phase 3)
...
## 7. Testing
- [x] 7.1 Unit tests for plot generation
  - Test each plot type
  - Test output formats
...
- [ ] 7.3 Visual regression tests
  - Compare generated plots — deferred (not in CI)
  - Test plot quality — deferred
  - Test different configurations — deferred
