...
- [x] 3.4 Update `count` command
  - Support S3 input paths
- [x] 3.5 Update other major commands
  - Add S3 support to commands that accept file paths

## 4. CLI Integration
- [x] 4.1 Add AWS credential documentation
  - Document environment variables
  - Document profile usage
  - Add examples
- [x] 4.2 Update help text
  - Document S3 URI format
  - Add S3 examples

## 5. Testing
- [x] 5.1 Unit tests for S3 connector
  - Test URI parsing
...
- [x] 5.3 Error handling tests
  - Test invalid credentials
  - Test missing buckets
  - Test network errors

## 6. Documentation
- [x] 6.1 Update README with S3 examples
- [x] 6.2 Document AWS credential setup
- [x] 6.3 Add S3 usage guide
