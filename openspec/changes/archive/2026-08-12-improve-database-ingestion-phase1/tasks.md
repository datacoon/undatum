...
- [ ] 2.2.1 Test with real MongoDB instance - Deferred
- [ ] 2.2.2 Test with real Elasticsearch instance - Deferred
- [ ] 2.2.3 Test with large files (100K+ rows) - Deferred
- [x] 2.2.4 Test error scenarios (connection failures, invalid data)
- [x] 2.2.5 Test partial batch failures
