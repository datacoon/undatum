...
from ..common.pipeline_parser import PipelineParseError, PipelineSpec, parse_pipeline, validate_pipeline
...
class PipelineRunner:
    ...
    def _execute_step(self, step: Dict[str, Any], step_name: str) -> bool:
        ...
        try:
            ...
            command_func = None
            for cmd_name, cmd_info in app.registered_commands.items():
                if cmd_name == command:
