...
class DatabaseLoader:
    ...
    def load(self, input_file: str, db_uri: str, table: str, 
             mode: str = 'append', create_table: bool = False,
             upsert_key: Optional[str] = None, **options):
        ...
        from ..common.db_connection import parse_db_uri, DatabaseConnectionError
        ...
        try:
            ...
            raise DatabaseError(
                f"Failed to parse database URI: {e}",
                connection_uri=db_uri
            ) from e
